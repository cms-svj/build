if [ "X${_CMSBUILD_BUILD_ENV_}" = "X" ] ; then
  ...
  test X$PHOTOSPP_ROOT != X || . /work/build/CMSSW_10_6_X/slc7_amd64_gcc700/tmp/slc7_amd64_gcc700/external/photospp/3.61-pafccj/etc/profile.d/init.sh
  test X$TAUOLAPP_ROOT != X || . /work/build/CMSSW_10_6_X/slc7_amd64_gcc700/tmp/slc7_amd64_gcc700/external/tauolapp/1.1.5-7d467e26d5d6e35b09276c76b1ee84c3/etc/profile.d/init.sh
fi
